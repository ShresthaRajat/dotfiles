...
declare -a programs=("vim" "python3" "python3-pip" "zsh" "code" "chromium" "firefox" "git" "curl" "cowsay" "tree" "sl" "neofetch" "lolcat" "lm-sensors" "tlp" "gnome-tweaks" "cmake" "vlc" "cmatrix" "wmctrl" "python3-setuptools" "xdotool" "python3-gi" "libinput-tools" "python-gobject")
